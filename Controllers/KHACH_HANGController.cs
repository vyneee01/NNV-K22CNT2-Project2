...
namespace ThuVienSach_NguyenNgocVy.Controllers
{
    public class KHACH_HANGController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,HoTen,NgaySinh,DiaChi,Email,SoDienThoai,TrangThai")] KHACH_HANG kHACH_HANG)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,HoTen,NgaySinh,DiaChi,Email,SoDienThoai,TrangThai")] KHACH_HANG kHACH_HANG)
        {
            if (ModelState.IsValid)
            {
