...
namespace ThuVienSach_NguyenNgocVy.Controllers
{
    public class QUAN_TRIController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaQuanTri,TenDangNhap,MatKhau,TrangThai")] QUAN_TRI qUAN_TRI)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaQuanTri,TenDangNhap,MatKhau,TrangThai")] QUAN_TRI qUAN_TRI)
        {
            if (ModelState.IsValid)
            {
